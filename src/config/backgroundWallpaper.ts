...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	common: {
		...
		homeText: {
			...
			enable: true,
			// 主页横幅主标题
			title: "Exploit the logic, patch the world",
			// 主页横幅主标题字体大小
			titleSize: "3.8rem",
			// 主页横幅副标题
			subtitle: [
                                "In Nested Loops, I Once Trapped",
                                "From Broken Stack, I Free Fall",
                                "Amidst Silent Logs, I Deep Sleep",
                                "Upon Rooted Shell, I Soon Gaze",
                                "From Zero-Day Night, I Thence Shine",
                                "In Patched Morrow, I Full Bloom",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
